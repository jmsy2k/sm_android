...
import com.extacy.ms.databinding.ViewPopupButtonBinding
...
class PopupButton: FrameLayout {
    ...
    fun setting(dialog: PopupCombin, confirmTitle:String? = null, confirmCallback: ButtonCallback? = null, cancelTitle:String? = null, cancelCallback: ButtonCallback? = null ) {
