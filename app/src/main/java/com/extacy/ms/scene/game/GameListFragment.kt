...
class GameListFragment: ViewBindingFragment<FragmentGameListBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.run {
            ...
            editSearchGame.setOnKeyListener { _, keyCode, event ->
            ...
            recyclerGameList.layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
            recyclerGameList.adapter = object: RVAdapter<CellGameListBinding>() {
